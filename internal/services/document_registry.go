...
var documentTypeRegistry = map[string]DocumentTypeSpec{
	...
	"contract_ukaby_visa":       mkDocxWithLegal("contract_ukaby_visa", "Договор UKABY (визовые услуги, рус/каз)", "contract_ukaby_visa.docx", "contract_ukaby_visa.docx", baseRequired(), nil, nil),
	...
	"contract_ukaby_30_35_35":   mkDocxWithLegal("contract_ukaby_30_35_35", "Договор UKABY 30/35/35 (рус/каз)", "contract_ukaby_30_35_35.docx", "contract_ukaby_30_35_35.docx", baseRequired(), extraKeys(optionalDealFallback("CONTRACT_NUMBER"), optionalDealFallback("CONTRACT_DATE_TEXT"), optional("PREPAYMENT_30"), optional("PREPAYMENT_30_TEXT"), optional("PAYMENT_35_DAY15"), optional("PAYMENT_35_DAY15_TEXT"), optional("PAYMENT_35_DAY30"), optional("PAYMENT_35_DAY30_TEXT")), map[string]string{"CONTRACT_NUMBER": "KUB-000001"}),
	"addendum_c01_extension":    mkDocx("addendum_c01_extension", "Доп. соглашение С-01 (продление)", "addendum_c01_extension.docx", baseRequired(), extraKeys(optionalDealFallback("MAIN_CONTRACT_NUMBER"), optionalDealFallback("MAIN_CONTRACT_DATE_TEXT"), optional("ADDENDUM_NUMBER"), optional("ADDENDUM_DATE_TEXT"), optional("EXTENSION_MONTHS"), optional("TOTAL_MONTHS")), map[string]string{"ADDENDUM_NUMBER": "С-01", "EXTENSION_MONTHS": "12", "TOTAL_MONTHS": "30"}),
