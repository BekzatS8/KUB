...
var baseRolePermissions = map[string][]Permission{
	...
	"quality_control": permissionsForScope(ScopeRelatedDepartments,
		"feed.view", "leads.view", "deals.view", "clients.view", "documents.view", "documents.download", "tasks.view", "reports.view", "chat.view", "messenger.view", "funnels.view",
	),
	...
	"visa": permissionsForScope(ScopeDepartment,
		"feed.view", "leads.view", "leads.create", "leads.update", "deals.view", "clients.view", "clients.update",
		"documents.view", "documents.create", "documents.update", "documents.send", "documents.download",
		"tasks.view", "tasks.create", "tasks.update", "chat.view", "messenger.view", "funnels.view", "approvals.create",
	),
	...
	"hr": permissionsForScope(ScopeDepartment,
		"feed.view", "documents.view", "documents.create", "documents.update", "documents.download", "tasks.view", "tasks.create", "tasks.update", "chat.view", "approvals.create",
	),
