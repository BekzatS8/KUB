...
SELECT
	...
	COALESCE(ip.specialty, ''), COALESCE(ip.trusted_person_phone, ''), COALESCE(ip.driver_license_number, ''), COALESCE(ip.education_institution_name, ''), COALESCE(ip.education_institution_address, ''), COALESCE(ip.position, ''), COALESCE(ip.visas_received, ''), COALESCE(ip.visa_refusals, ''),
...
SELECT
	...
	'' AS specialty, '' AS trusted_person_phone, '' AS driver_license_number, '' AS education_institution_name, '' AS education_institution_address, '' AS position, '' AS visas_received, '' AS visa_refusals,
...
func scanClient(scanner clientRowScanner) (*models.Client, error) {
	...
	err := scanner.Scan(
		...
		&ip.Specialty, &ip.TrustedPersonPhone, &ip.DriverLicenseNumber, &ip.EducationInstitutionName, &ip.EducationInstitutionAddress, &ip.Position, &ip.VisasReceived, &ip.VisaRefusals,
