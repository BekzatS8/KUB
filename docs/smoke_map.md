...
| H. Reports branch filter | `/reports/funnel`, `/reports/leads`, `/reports/revenue` (+ `branch_id`) | sales/operations/control/leadership/system_admin | deals/leads stats + branch scope | leadership/system_admin can filter by branch; sales/operations/control stay on own branch |
